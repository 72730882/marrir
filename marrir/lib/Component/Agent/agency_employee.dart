...
class AgencyEmployeePage extends StatefulWidget {
  ...
  @override
  State<AgencyEmployeePage> createState() => _AgencyEmployeePageState();
}

class _AgencyEmployeePageState extends State<AgencyEmployeePage> {
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: const Color.fromRGBO(101, 178, 201, 1),
...
// ===== Add Employee Dialog =====
// (remains the same as your code, no need for fetchEmployees here)
  ...
  Future<void> submitEmployee() async {
    ...
    try {
      final data = {
        ...
        "country": "Ethiopia", // or make a text field to input
