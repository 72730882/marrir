...
class _TransferHistoryPageState extends State<TransferHistoryPage> {
        ...
        children: [
          ...
          RichText(
            text: TextSpan(
              children: [
                TextSpan(
                  text: title == "Transfer Requested"
                      ? "Count - "
                      : "Count - ", // optional multilingual
                  style: const TextStyle(
                    fontSize: 14,
                    color: Colors.black,
                  ),
  ...
  Widget _buildShowRowsDropdown(LanguageProvider lang) {
    return Row(
