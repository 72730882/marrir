            ...
            children: [
              ...
              if (isGraduate) ...[
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: const [
                    ...
                    DropdownMenuItem(
                        value: "Vocational", child: Text("Vocational")),
                    DropdownMenuItem(
                        value: "Some College Course",
                        child: Text("Some College Course")),
              ...
              DropdownButtonFormField<String>(
                ...
                items: const [
                  ...
                  DropdownMenuItem(
                      value: "Home Framer", child: Text("Home Framer")),
                  DropdownMenuItem(
        ...
        return SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 30),
              buildLabel('Name'),
              buildTextField(placeholder: 'Enter Name'),
              const SizedBox(height: 16),
              buildLabel('Email'),
              buildTextField(placeholder: 'Enter Email'),
              const SizedBox(height: 16),
              ...
              const SizedBox(height: 16),
              buildLabel('City'),
              buildTextField(placeholder: 'Enter City'),
              const SizedBox(height: 16),
              buildLabel('Sub City'),
              buildTextField(placeholder: 'Enter Sub City'),
              const SizedBox(height: 16),
              buildLabel('Zone'),
              buildTextField(placeholder: 'Enter Zone'),
              const SizedBox(height: 16),
              Row(
                children: [
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        buildLabel('P.O. Box'),
                        buildTextField(placeholder: 'Enter P.O.Box'),
                      ],
                    ),
                  ),
                  const SizedBox(width: 10),
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        buildTextField(placeholder: 'Enter House Number'),
                      ],
                    ),
                  ),
                ],
              ...
              const SizedBox(height: 16),
              buildLabel('Reference Summary'),
              buildTextField(placeholder: 'Enter summary', maxLines: 4),
              const SizedBox(height: 30),
              SizedBox(
                width: double.infinity,
                child: ElevatedButton(
